...
var qA = {
			1:{
				question:'Who sang - Best Days of Your Life',
				answers:['Miranda Lambert','Reba MacIntyre','Kellie Pickler','Carrie Underwood'],
				correct:'Miranda Lambert',
				right: 'Correct!',
				wrong: 'Wrong!',
				imageUrl:'assets/images/kelliepickler.png'
			   },
			2:{
				question:'Who sang - Two Black Cadillacs?',
				answers:['Taylor Swift','Faith Hill','Carrie Underwood','Kellie Pickler'],
				correct:'Carrie Underwood',
				right: 'Correct!',
				wrong: 'Wrong!',
				imageUrl:'assets/images/carrieunderwood.png'
			},
			3:{
				question:'Who sang - Sure Be Cool If You Did',
				answers:['Black Shelton','Luke Bryan','Adam Lambert','Brad Paisley'],
				correct:'Blake Shelton',
				right: 'Correct!',
				wrong: 'Wrong!',
				imageUrl:'assets/images/blakeshelton.png'
			}
    };
